...
command_not_found_handler () {
	if /Users/snellin/.local/bin/mise hook-not-found -s zsh -- "$1"
	then
		_mise_hook
		"$@"
...
mise () {
	...
	if [ "$#" = 0 ]
	then
		command /Users/snellin/.local/bin/mise
		return
	fi
	shift
	case "$command" in
		(deactivate | s | shell) if [[ ! " $@ " =~ " --help " ]] && [[ ! " $@ " =~ " -h " ]]
			then
				eval "$(command /Users/snellin/.local/bin/mise "$command" "$@")"
				return $?
			fi ;;
	esac
	command /Users/snellin/.local/bin/mise "$command" "$@"
}
mkcd () {
	mkdir -p $@ && cd ${@:$#}
}
...
mwinit_validate () {
	...
	if (
			...
			test "`find ~/.ssh/id_ecdsa-cert.pub -mmin +1220`"
		)
	then
...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/snellin/.local/share/mise/installs/node/20.18.0/lib/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/arm64-darwin/rg'
fi
export PATH='/Users/snellin/.local/share/mise/installs/python/3.12/bin:/Users/snellin/.local/share/mise/installs/python/3.11/bin:/Users/snellin/.local/share/mise/installs/python/3.10/bin:/Users/snellin/.local/share/mise/installs/python/3.9/bin:/Users/snellin/.local/share/mise/installs/python/3.8/bin:/Users/snellin/.local/share/mise/installs/node/lts/bin:/Users/snellin/Library/Python/3.9/bin:/usr/local/opt/gnu-getopt/bin:/usr/local/opt/openssl@1.0.2t/bin:/Applications/Sublime Text.app/Contents/SharedSupport/bin:/opt/homebrew/opt/node@14/bin:/Users/snellin/.cargo/env:/Users/snellin/.local/bin:/Users/snellin/tools:/Users/snellin/bin:/usr/local/bin:/Users/snellin/.toolbox/bin:/apollo/env/envImprovement/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/Users/snellin/Library/Python/3.9/bin:/usr/local/opt/gnu-getopt/bin:/usr/local/opt/openssl@1.0.2t/bin:/Applications/Sublime Text.app/Contents/SharedSupport/bin:/opt/homebrew/opt/node@14/bin:/Users/snellin/.cargo/env:/Users/snellin/.local/bin:/Users/snellin/tools:/Users/snellin/bin:/Users/snellin/.toolbox/bin:/apollo/env/envImprovement/bin:/Users/snellin/.cargo/bin:/Applications/iTerm.app/Contents/Resources/utilities:/Applications/Visual Studio Code.app/Contents/Resources/app/bin:/Users/snellin/Library/Application Support/JetBrains/Toolbox/scripts:/apollo/env/CodeSearchCLI/bin/:/Users/snellin/.fzf/bin:/apollo/env/CodeSearchCLI/bin/'
