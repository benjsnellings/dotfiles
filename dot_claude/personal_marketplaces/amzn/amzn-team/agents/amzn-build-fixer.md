...
description: |
  ...
  assistant: "I'll use the amzn-build-fixer agent to diagnose the failure, apply a fix, and verify the build passes."
  ...
  assistant: "I'll use the amzn-build-fixer agent to resolve the dependency issue and verify the build."
  ...
  assistant: "I'll use the amzn-build-fixer agent to diagnose and fix the test failures."
...
- **NEVER commit changes** — leave that to amzn-commit
