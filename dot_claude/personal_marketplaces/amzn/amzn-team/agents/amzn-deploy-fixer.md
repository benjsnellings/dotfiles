...
description: |
  ...
  assistant: "I'll use the amzn-deploy-fixer to diagnose the stuck CloudFormation deployment and recommend remediation."
  ...
  assistant: "I'll use the amzn-deploy-fixer to investigate the Apollo deployment failure."
  ...
  assistant: "I'll use the amzn-deploy-fixer to triage the pipeline and identify what's blocking it."
