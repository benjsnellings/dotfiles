...
description: |
  ...
  assistant: "I'll use the amzn-researcher agent to research OrderService's payment flow across specs, code, and documentation."
  ...
  assistant: "I'll use the amzn-researcher agent to discover DDB stream producers across internal search and code repositories."
  ...
  assistant: "I'll use the amzn-researcher agent to find rate limiting patterns across Coral service specs and code."
