...
This plugin provides an intelligent agent for working with Amazon's CRUX code review system. The `amzn-cr` agent helps you:
...
The `amzn-cr` agent automatically activates when you:
...
/plugin install amzn-cr@amzn

# Or test locally
claude --plugin-dir ./amzn/amzn-cr
```
