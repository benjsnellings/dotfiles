...
|-------|-----------|-----------|
| **researcher** | Codebase research, service discovery, pattern finding | `team:researcher` |
| **build-fixer** | Build failure diagnosis and autonomous repair | `team:build-fixer` |
| **test-debugger** | Integration test investigation (ToD/Hydra) | `team:test-debugger` |
| **deploy-fixer** | Pipeline/deployment troubleshooting | `team:deploy-fixer` |
| **workspace-coord** | Multi-package dependency management | `team:workspace-coord` |
| **commit** | Git operations (commit, branch, status) | `commit:commit` |
| **cr** | Code review operations (create CR, address feedback) | `cr:cr` |
