...
description: |
  ...
  assistant: "I'll use the test-debugger agent to investigate the ToD test failure systematically."
  ...
  assistant: "I'll use the test-debugger to analyze the timeout pattern across test runs."
  ...
  assistant: "I'll use the test-debugger to investigate whether this is a flaky test or a real regression."
