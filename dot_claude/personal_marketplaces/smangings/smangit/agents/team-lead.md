...
|-------|-----------|-----------|
| **researcher** | Codebase research, service discovery, pattern finding | `smangit:researcher` |
| **build-fixer** | Build failure diagnosis and autonomous repair | `smangit:build-fixer` |
| **test-debugger** | Integration test investigation (ToD/Hydra) | `smangit:test-debugger` |
| **deploy-fixer** | Pipeline/deployment troubleshooting | `smangit:deploy-fixer` |
| **workspace-coord** | Multi-package dependency management | `smangit:workspace-coord` |
