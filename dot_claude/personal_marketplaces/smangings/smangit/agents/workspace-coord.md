...
description: |
  ...
  assistant: "I'll use the workspace-coord to map dependencies and plan the cross-package implementation order."
  ...
  assistant: "I'll use the workspace-coord to resolve the version conflicts across your workspace."
  ...
  assistant: "I'll use the workspace-coord to map the workspace dependency graph and build order."
